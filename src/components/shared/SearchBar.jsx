    ...
    return (
        <div className="hidden md:block relative">
            <input
                type="text"
                placeholder="Buscar..."
                className="pl-3 pr-10 py-2 rounded-md text-sm w-36 lg:w-48 focus:outline-none bg-gray-100 focus:bg-white border-gray-200 dark:bg-gray-800 dark:focus:bg-gray-700 dark:border-gray-700 border"
            />
